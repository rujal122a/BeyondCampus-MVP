        ...
        <div className={cn("container mx-auto px-4", viewMode === "map" ? "pt-6" : "")}>
            {viewMode === "list" ? (
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
                    ...
                    >
                        <h1 className="text-4xl font-bold text-slate-900 mb-2">Find Your Community</h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 items-center mb-6 gap-4">
                    ...
                    <h1 className="text-2xl md:text-3xl font-bold text-slate-900 text-left md:text-center">
                        BeyondCampus <span className="text-slate-500">Stays</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {FLATS.map((flat, index) => (
                        ...
                        >
                            <FlatCard
                                flat={flat}
                                onShowOnMap={() => handleShowOnMap(flat.coordinates)}
                            />
                        </motion.div>
                    ))}
                </div>
